...
class ListOrganizations200ResponseOrganizationsInner(BaseModel):
    ...
    icon_url: Optional[StrictStr] = Field(
        default=None, description="Pre-signed URL for the organization's icon", alias="iconUrl"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"id": obj.get("id"), "name": obj.get("name"), "iconUrl": obj.get("iconUrl"), "slug": obj.get("slug")}
        )
        return _obj
