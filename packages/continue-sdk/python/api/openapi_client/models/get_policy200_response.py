...
class GetPolicy200Response(BaseModel):
    ...
    org_slug: Optional[StrictStr] = Field(
        default=None, description="Slug of the organization that has the policy", alias="orgSlug"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"policy": obj.get("policy"), "orgSlug": obj.get("orgSlug")})
        return _obj
