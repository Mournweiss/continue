...
class SyncSecretsRequest(BaseModel):
    ...
    org_scope_id: Optional[StrictStr] = Field(
        default=None, description="Organization ID to scope secret resolution to", alias="orgScopeId"
    )
    org_scope_slug: Optional[StrictStr] = Field(
        default=None, description="Organization slug to scope secret resolution to", alias="orgScopeSlug"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"fqsns": obj.get("fqsns"), "orgScopeId": obj.get("orgScopeId"), "orgScopeSlug": obj.get("orgScopeSlug")}
        )
        return _obj
