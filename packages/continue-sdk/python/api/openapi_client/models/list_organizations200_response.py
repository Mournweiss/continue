...
from openapi_client.models.list_organizations200_response_organizations_inner import (
...
class ListOrganizations200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "organizations": [
                    ListOrganizations200ResponseOrganizationsInner.from_dict(_item) for _item in obj["organizations"]
                ]
